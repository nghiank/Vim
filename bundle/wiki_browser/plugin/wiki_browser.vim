" $Id: //brazil/src/appgroup/envImprovement/apps/NinjaHooks/mainline/vim/plugin/wiki_browser.vim#8 $
" 
...
function! <SID>_WikiTag()
  let b:wiki_node = expand('<cfile>')
  " TODO cfile here will work in almost all cases but doesn't cover categories.
  " We should really implement our own <cfile> that addresses categories and
  " checks '[[ ]]' before jumping. Also, is there any way we can add the old 
  " spot back into the tag stack? [goodell@]
  " 
